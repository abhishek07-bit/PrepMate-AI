        ...
        <div className="lg:col-span-7 flex flex-col gap-lg">
          ...
          <section className="bg-[var(--color-card-bg)] border border-[var(--color-card-border)] rounded-pebble p-container-padding">
            ...
            <div className="flex items-center gap-lg mb-xl">
              <div className="w-24 h-24 rounded-full overflow-hidden bg-surface-container-low border border-outline-variant shrink-0 flex items-center justify-center">
            ...
            <form className="flex flex-col gap-md">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
                <div className="flex flex-col gap-xs">
                  <label className="font-label-bold text-label-bold text-primary" htmlFor="firstName">First Name</label>
                  <input className="bg-surface-container-lowest border border-outline-variant rounded-input p-sm font-body-md text-body-md text-on-background focus:border-primary focus:ring-0 outline-none transition-colors" id="firstName" type="text" defaultValue={user?.firstName || ''} />
                </div>
                <div className="flex flex-col gap-xs">
                  <label className="font-label-bold text-label-bold text-primary" htmlFor="lastName">Last Name</label>
                  <input className="bg-surface-container-lowest border border-outline-variant rounded-input p-sm font-body-md text-body-md text-on-background focus:border-primary focus:ring-0 outline-none transition-colors" id="lastName" type="text" defaultValue={user?.lastName || ''} />
                </div>
              </div>
              <div className="flex flex-col gap-xs">
                <label className="font-label-bold text-label-bold text-primary" htmlFor="email">Email Address</label>
                <input className="bg-surface-container-lowest border border-outline-variant rounded-input p-sm font-body-md text-body-md text-on-background focus:border-primary focus:ring-0 outline-none transition-colors" id="email" type="email" defaultValue={user?.email || ''} />
              </div>
              <div className="mt-md flex justify-end">
                <button className="bg-surface-container-lowest text-primary border border-outline-variant px-md py-sm rounded-btn font-label-bold text-label-bold hover:bg-surface-container transition-colors" type="button">Save Changes</button>
              </div>
            </form>
          </section>
          ...
          {/* Resume */}
          <section className="bg-[var(--color-card-bg)] border border-[var(--color-card-border)] rounded-pebble p-container-padding">
            <h3 className="font-headline-md text-headline-md text-primary mb-lg border-b border-outline-variant pb-sm">Resume Management</h3>
            ...
            {resume.file ? (
              <div className="bg-surface-container-lowest border border-outline-variant rounded-btn p-md flex items-center justify-between mb-md">
                <div className="flex items-center gap-md">
                  <FileText size={32} className="text-secondary" strokeWidth={1.5} />
                  <div>
              ...
              <p className="font-body-md text-body-md text-secondary mb-md opacity-60">No resume uploaded yet.</p>
            )}

            <div className="border-2 border-dashed border-outline-variant rounded-btn p-lg flex flex-col items-center justify-center text-center gap-sm bg-surface-container-lowest cursor-pointer hover:border-primary transition-colors group">
              <Upload size={32} className="text-secondary group-hover:text-primary transition-colors" strokeWidth={1.5} />
              <p className="font-label-bold text-label-bold text-primary">Click to upload or drag and drop</p>
