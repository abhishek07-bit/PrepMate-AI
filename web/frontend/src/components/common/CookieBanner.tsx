    ...
    <div className="fixed bottom-0 left-0 w-full bg-surface-container-high border-t border-outline-variant p-md md:p-lg z-[100] flex flex-col md:flex-row items-center justify-between gap-md animate-slide-up shadow-2xl">
      ...
      <div className="flex items-center gap-sm shrink-0">
        <button
          ...
          className="px-lg py-sm rounded-pebble border border-outline-variant font-label-bold text-label-sm text-secondary hover:bg-surface-container-low transition-colors"
        >
          Decline Non-Essential
        </button>
        <button
          onClick={handleAccept}
          className="px-lg py-sm rounded-pebble bg-primary text-on-primary font-label-bold text-label-sm hover:shadow-md transition-all active:scale-95"
        >
          Accept All
        </button>
      </div>
